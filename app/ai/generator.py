            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "Твоя задача — написать короткий, цепляющий пост (до 500 символов) на основе новости. "
                        "Пост не должен отправлять на сторонние ресурсы. "
                        "Пост должен быть конечным и не подразумевать продолжения в какой-то статье. "
